...
function submit() {
    ...
    // endpoint: /panel/cliente/profile
    form.clearErrors();
    form.post("/panel/cliente/profile", { data } as unknown as any);
}
</script>
...
<template>
    <section class="card shadow-sm">
        ...
        <p class="text-sm text-slate-600 mt-2">
            Editá tu perfil, cambiá contraseña y agregá teléfono o foto.
        </p>
        ...
        <div class="mt-4 space-y-3">
            ...
            <div>
                <button @click.prevent="submit" class="btn-primary">
                    Guardar cambios
                </button>
            </div>
        </div>
